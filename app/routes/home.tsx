...
import { createProject, getProjets } from "../../lib/puter.action";
  ...
  return (
    <div className="home">
      ...
      <section className="hero">
        ...
        <h1>Build beautiful spaces at speed of thought with Roomify</h1>
        <p className="subtitle">Roomify is an AI-first design environment that helps you visualize, render and ship architecture projects faster than ever.</p>
        ...
        <div className="upload-shell" id="upload">
          ...
          <div className="upload-card">
            <div className="upload-head">
              ...
              <p>Supports JPJ, PNG formats up to 10MB</p>
            </div>
